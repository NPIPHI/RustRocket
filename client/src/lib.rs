...
pub fn run_frame() {
    ...
    unsafe {
        if rocket_data_row_index < ROCKET_DATA_VEC.len() {
            ...
            console::log_1(&JsValue::from_str("Reached end of rocket data"));
        }
    }
    ...
    // let (ecef_x, ecef_y, ecef_z) = map_3d::geodetic2ecef(rd.latitude, rd.longitude, rd.barometer_altitude);
    // let ecef = &glm::vec3(ecef_x as f32, ecef_y as f32, ecef_z as f32);
